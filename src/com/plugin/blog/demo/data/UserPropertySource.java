...
public class UserPropertySource implements IPropertySource {
	...
	public IPropertyDescriptor[] getPropertyDescriptors() {
		TextPropertyDescriptor namePropertyDescriptor = new TextPropertyDescriptor(PROPERTY_NAME, "ÐÕÃû");

		ComboBoxPropertyDescriptor agePropertyDescriptor = new ComboBoxPropertyDescriptor(PROPERTY_CATEGORY, "Àà±ð",
				User.CATEGORY_ARRAY);
